...
interface DepositOverlayProps {
  onSelectTier: (tier: AccountTier) => void;
}
...
export function DepositOverlay({ onSelectTier }: DepositOverlayProps) {
  ...
  const tiers = [
    { id: 1 as const, deposit: 35, label: 'Tier I Escrow', desc: 'Earn a flat $1.70 profit daily by completing 1 assignment.' },
    { id: 2 as const, deposit: 70, label: 'Tier II Escrow', desc: 'Earn up to $3.40 flat profit daily by completing 2 assignments ($1.70 each).', badge: 'Premium' },
  ];
